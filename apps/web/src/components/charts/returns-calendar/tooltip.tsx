        ...
        typeof children === "function"
          ...
          : (children ?? (
              <>
                ...
                <span
                  className="data-chart-tooltip-value inline-flex items-center font-mono tabular-nums"
                  style={
                    {
                      "--data-chart-tooltip-color": ink(tipValue >= 0 ? UP : DOWN),
                    } as CSSProperties
                  }
                >
                  <NumberTicker
