      ...
      {typeof document !== "undefined"
        ? createPortal(
            <AnimatePresence>
              {open && coords ? (
                <span
                  className="motion-tooltip-anchor pointer-events-none fixed z-[9999]"
                  style={
                    {
                      "--motion-tooltip-top": `${coords.top}px`,
                      "--motion-tooltip-left": `${coords.left}px`,
                      "--motion-tooltip-transform": anchorTransform[side],
                      "--motion-tooltip-origin": transformOrigin[side],
                    } as CSSProperties
                  }
                >
                  <TooltipSurface
                    ...
                    id={id}
                    side={side}
                    className={cn("motion-tooltip-surface", className)}
                  >
                    {content}
                  </TooltipSurface>
                </span>
